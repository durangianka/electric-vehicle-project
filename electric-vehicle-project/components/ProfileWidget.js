            ...
            <div className="w-full h-full flex flex-row p-2 space-x-6 items-center justify-center rounded-xl bg-black bg-opacity-60 font-medium text-white text-xl">
                <div className=" flex flex-row items-center justify-center">
                    ...
                    <div className="flex flex-col">
                        <p className='text-3xl'>{`${user.name} ${user.surname}`}</p>
                        <p className='text-xs tracking-widest'><i>{user.job}</i></p>
                    </div>
                </div>
                <img className="w-16 h-16 rounded-full object-cover" src={user.ppic} alt="profile picture"></img>
            </div>
        </div >
    )
}
...
const JobCardIcon = () => {
    return (
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            width="70" height="70" viewBox="0 0 487.451 487.451" fill="white"
            xmlSpace="preserve">
            <g>
